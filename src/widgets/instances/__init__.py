...
from .openai_instances import ChatGPT, Gemini, Together, Venice, Deepseek, OpenRouter, Anthropic, Groq, Qwen, Fireworks, LambdaLabs, Cerebras, Klusterai, LlamaAPI, Mistral, NovitaAI, GenericOpenAI
...
if os.getenv('ALPACA_OLLAMA_ONLY', '0') == '1':
    ...
    ready_instances = [OllamaManaged, Ollama, ChatGPT, Gemini, Together, Venice, Deepseek, OpenRouter, Anthropic, Groq, Qwen, Fireworks, LambdaLabs, Cerebras, Klusterai, LlamaAPI, Mistral, NovitaAI, GenericOpenAI]
