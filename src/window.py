...
class AlpacaWindow(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs):
        ...
        universal_actions = {
            ...
            'delete_every_chat': [lambda *i: dialog_widget.simple(_('Delete Every Chat?'), _('Are you sure you want to delete every chat?'), lambda: [self.chat_list_box.delete_chat(c.chat_window.get_name()) for c in self.chat_list_box.tab_list], _('Delete'), 'destructive')]
        }
